...
const DropdownMenu = () => {
    ...
    return (
        <div className={classes.dropdown} style={{ height: menuHeight+30 }} ref={dropdownRef}>
        <CSSTransition
          in={activeMenu === "main"}
          timeout={500}
          // menu-primary
        ...
        >
          <div className={classes.menu}>
            <DropdownItem><h1>Categories</h1></DropdownItem>
            <DropdownItem leftIcon="🦧" goToMenu="settings" setMenu={setActiveMenuHandler}>
              Settings
            </DropdownItem>
            <DropdownItem leftIcon="🦧" goToMenu="animals" setMenu={setActiveMenuHandler}>
              Animals
            </DropdownItem>
          </div>
        </CSSTransition>
        ...
        >
          <div className={classes.menu}>
            <DropdownItem goToMenu="main" leftIcon="🦧" setMenu={setActiveMenuHandler}>
              <h2>Languages</h2>
            </DropdownItem>
